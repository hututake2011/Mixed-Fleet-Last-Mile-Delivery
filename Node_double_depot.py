...
Area2Nodes = [4842, 4989, 4572, 4121, 4143, 4818, 4823, 5784, 5790, 4501, 4532, 4657, 4269, 4624, 4722, 4758, 5889,
              5721, 5892, 5772, 5740, 4641, 5841, 5859, 5850, 5984, 5920, 5914, 5907, 6835, 6021, 6038, 6014, 5807,
              5945, 5976, 4272, 4538]

Area1Nodes = [4191, 3868, 3704, 3864, 3712, 3895, 3940, 3915, 3784, 3983, 3952, 4944, 4917, 4975, 4906, 4959, 5040,
              5053, 5019, 5036, 5070, 4185, 4107, 4035, 4054, 4012, 4322, 4470, 4443, 5078, 5020, 4189, 4323]

Area1Set = dataframe.loc[dataframe['NID'].isin(Area1Nodes)]
Area2Set = dataframe.loc[dataframe['NID'].isin(Area2Nodes)]
...
Area1Matrix, Area1TimeMatrix = Gen_distance_time_Matrix(Area1Nodes, Area1Set, Area1Demand)
Area2Matrix, Area2TimeMatrix = Gen_distance_time_Matrix(Area2Nodes, Area2Set, Area2Demand)
