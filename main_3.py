...
from Input_nodes import largeMatrix, largeTimeMatrix
    # Matrix2K, TimeMatrix2K, Matrix1K, TimeMatrix1K, \
    # Area1Marix, Area1TimeMatrix, Area2Marix, Area2TimeMatrix
...
# OutputDirectory = 'C:\\Users\\Dingtong Yang\\PycharmProjects\\Mix_Fleet_Delivery\\Output\\April25_Result'
...
for EVrange in [200]:
    for EVnum in [0]:
        for num_vehicle in range(25, 30):
            ...
            # # Function call for 2k Demand
            # Main_function(Matrix2K, TimeMatrix2K, num_vehicle, vehicle_range, para.EV_cost_per_mile,
            #               para.GV_cost_per_mile, num_ev)
            # Function call for 1k Demand
            # Main_function(Matrix1K, TimeMatrix1K, num_vehicle, vehicle_range, para.EV_cost_per_mile,
            #               para.GV_cost_per_mile, num_ev)

            # # Function call for half size area
            # Main_function(Area1Marix, Area1TimeMatrix, num_vehicle, vehicle_range, para.EV_cost_per_mile,
            #               para.GV_cost_per_mile, num_ev)

            # # Function call for 1/4 size area
            # Main_function(Area2Marix, Area2TimeMatrix, num_vehicle, vehicle_range, para.EV_cost_per_mile,
            #               para.GV_cost_per_mile, num_ev)
